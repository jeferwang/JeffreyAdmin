		...
		<div class="col-md-12 panel">
			...
			<form class="panel-body" method="post" action="{{route('admin.menu.add-admin-menu')}}" id="add-form">
				...
				<div class="form-group col-md-1">
					<label for="url" class="control-label">排序</label>
					<input class="form-control" name="sort_num" id="sort_num" placeholder="默认0">
				</div>
				<div class="form-group col-md-1">
		...
		function deleteMenu(mid) {
			layer.alert('确认删除此菜单以及所包含的子菜单吗 ? ', {
				...
				, yes: function () {
					...
					ajaxOptions.url = '{{route('admin.menu.del-admin-menu')}}';
					ajaxOptions.data = {'_token': csrfToken, 'mid': mid};
