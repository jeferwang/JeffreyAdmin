	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="brand">
			<a href="{{route('admin.index.index')}}">
				<img src="{{asset(config('static.dir.admin').'/assets/img/logo-dark.png')}}" alt="Klorofil Logo" class="img-responsive logo">
			</a>
		</div>
		<div class="container-fluid">
			<div class="navbar-btn">
			...
			<form action="https://www.baidu.com/s" method="get" target="_blank" class="navbar-form navbar-left">
				<div class="input-group">
					<input name="wd" class="form-control" placeholder="Baidu...">
			...
			<div id="navbar-menu">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="{{asset(config('static.dir.admin').'/assets/img/user.png')}}" class="img-circle" alt="Avatar">
